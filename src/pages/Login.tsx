                    ...
                    {(viewMode === 'password' || viewMode === 'full') && (
                        ...
                        >
                            ...
                            <div className="relative flex py-2 items-center">
                                ...
                                <span className="flex-shrink-0 mx-4 text-xs font-black text-slate-500 uppercase tracking-widest">O continúa con</span>
                                <div className="flex-grow border-t border-white/10"></div>
                            </div>
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full bg-white text-slate-900 hover:bg-slate-100 font-bold py-4 rounded-2xl shadow-lg transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                            >
